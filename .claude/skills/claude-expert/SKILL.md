---
name: claude-expert
description: "Use when: (1) creating Claude Code artifacts (skills, agents, hooks), (2) auditing existing artifacts for compliance, (3) choosing which artifact type fits a use case"
---
